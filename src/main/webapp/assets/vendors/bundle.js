                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[i]) {
                          if (r.length) (k.event.special[i] || {}).delegateType && e.stopPropagation();
                              ...
                              ((r = s.call(arguments)), Q.set(this, i, r), (t = o(this, i)), this[i](), r !== (n = Q.get(this, i)) || t ? Q.set(this, i, !1) : (n = {}), r !== n)
                          )
...
("function" == typeof define && define.amd
    ...
    return (function () {
        ...
        function w(e, t) {
            return (
                e || (e = O()),
                (h = D("#" + e.containerId)).length || (t && ((n = e), (h = D("<div/>").attr("id", n.containerId).addClass(n.positionClass)).appendTo(D(n.target)), (h = h))),
                h
            );
            var n;
        }
        ...
        function l(t) {
            ...
            if (
                ...
                return (
                    ...
                    0 < o.timeOut &&
                        ((i = setTimeout(p, o.timeOut)),
                        (c.maxHideTime = parseFloat(o.timeOut)),
                        (c.hideEta = new Date().getTime() + c.maxHideTime),
                        o.progressBar && (c.intervalId = setInterval(f, 10))),
                    o.closeOnHover && a.hover(g, m),
            ...
            function m() {
                (0 < o.timeOut || 0 < o.extendedTimeOut) &&
                    ((i = setTimeout(p, o.extendedTimeOut)), (c.maxHideTime = parseFloat(o.extendedTimeOut)), (c.hideEta = new Date().getTime() + c.maxHideTime));
            }
            function g() {
                    ...
                    if (
                        ...
                        if (
                            ...
                            (T.onpreventclick = function (e) {
                                ...
                                M.grabcursorenabled &&
                                    P.cursorgrabvalue &&
                                    (T.css(T.ispage ? T.doc : T.win, { cursor: P.cursorgrabvalue }), T.css(T.rail, { cursor: P.cursorgrabvalue }));
                        else {
                            var L = function (e) {
                                if (T.selectiondrag) {
                                    if (e) {
                        ...
                        if (
                            ...
                            M.emulatetouch &&
                                (T.bind(T.win, "mousedown", T.ontouchstart, !1, !0), T.bind(l, "mouseup", T.ontouchend, !1, !0), T.bind(l, "mousemove", T.ontouchmove, !1, !0)),
                    ...
                    if ((T.cursortimeout && (clearTimeout(T.cursortimeout), (T.cursortimeout = 0)), T.rail)) {
                        if (
                            ...
                            (T.rail.drag && 1 == T.rail.drag.pt) ||
                                (void 0 !== e && !1 !== e && (T.scroll.y = (e / T.scrollratio.y) | 0), void 0 !== o && (T.scroll.x = (o / T.scrollratio.x) | 0)),
                ...
                return function (n, i) {
                    ...
                    return c < 0 || c >= y
                        ? e
                            ? ""
                            : void 0
                        : (r = a.charCodeAt(c)) < 55296 || r > 56319 || c + 1 === y || (o = a.charCodeAt(c + 1)) < 56320 || o > 57343
                        ? e
                            ? a.charAt(c)
                            : r
                        : e
