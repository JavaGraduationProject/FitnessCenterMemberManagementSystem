            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="gonggaobianhao" value="${param.gonggaobianhao}" />
                    </div>
                    <div class="form-group">
                        公告标题

                        <input type="text" class="form-control" style="" name="gonggaobiaoti" value="${param.gonggaobiaoti}" />
                    </div>
