                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    ><c:set var="i" value="${i+1}"/><c:set var="map" value="${map}" scope="request"/>
                        <tr id="${map.id}" pid="">
                            ...
                            <td align="center">
                                <a href="xiaofeixinxi_add.do?id=${map.id}">消费</a>



                                <a href="chongzhixinxi_add.do?id=${map.id}">充值</a>



                                <a href="huiyuanka_detail.do?id=${map.id}">详情</a>

                                <a href="huiyuanka_updt.do?id=${map.id}">编辑</a>

                                <a href="huiyuanka_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                    </c:forEach>
