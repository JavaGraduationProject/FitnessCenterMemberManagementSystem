...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑会员卡:</div>
            <div class="panel-body">
                <form action="huiyuankaupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->

                    <input type="hidden" name="kehuid" value="${mmm.kehuid}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="huiyuankahao"
                                    name="huiyuankahao"
                                    value="${Info.html(mmm.huiyuankahao)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    name="youxiaoriqi"
                                    readonly="readonly"
                                    value="${Info.html(mmm.youxiaoriqi)}"
                                />
                            </div>
                        </div>
                    </div>
